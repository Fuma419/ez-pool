...
sudo docker network rm ezNet
sudo docker network create --subnet=172.18.0.0/16 hodlNet

sudo docker pull cardanocommunity/cardano-node:stage1
sudo docker pull cardanocommunity/cardano-node:stage2
sudo docker pull cardanocommunity/cardano-node:stage3
sudo docker pull cardanocommunity/cardano-node:latest
